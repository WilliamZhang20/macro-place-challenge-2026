"""
Step 2 — Global placement: smooth HPWL + FFT electrostatic density (ePlace-style).

Lambda on density ramps up during optimization. Still no legalization.

Usage:
  uv run evaluate submissions/descent_step02_density_placer.py -b ibm01
"""
...
class DescentStep02DensityPlacer:
    def __init__(self):
        self.iters = 480
        self.lr = 0.045
