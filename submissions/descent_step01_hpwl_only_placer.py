"""
Step 1 — Pure smooth HPWL descent on movable hard macros (diagnostic).

Soft macros and fixed hard macros stay at initial coordinates. No density,
no legalization: expect many overlaps and invalid Tier-1 submissions, but
monotone wirelength reduction in the smoothed objective.

Usage:
  uv run evaluate submissions/descent_step01_hpwl_only_placer.py -b ibm01
"""
...
class DescentStep01HpwlOnlyPlacer:
    def __init__(self):
        self.iters = 500
        self.lr = 0.08
    ...
    def place(self, benchmark: Benchmark) -> torch.Tensor:
        ...
        beta = 1.0 / (0.01 * max(benchmark.canvas_width, benchmark.canvas_height))
